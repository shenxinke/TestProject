                ...
                if (response.getCode() == 1) {
                    ...
                    if (imgEmpty != null && tvCommentNum != null) {
                        if (mCommentData.size() > 0) {
                            ...
                            tvCommentNum.setText(ConstUtils.changeEmptyStringToZero(response.getMsg())+ "条评论");
                        } else {
                    ...
                    contentBean.setCommentNum(Utils.isNumeric(ConstUtils.getStringNoEmpty(response.getMsg()))
                            ? Integer.parseInt(ConstUtils.changeEmptyStringToZero(response.getMsg())): Const.INTEGER_0);
