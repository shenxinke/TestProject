...
public class EditTextWithListPopupWindow extends EditText {
    ...
    private void init(Context context) {
        ...
        if (rightDrawable == null) {
            rightDrawable = getResources().getDrawable(MyResource.getIdByName(
        ...
        list = getResources().getStringArray(MyResource.getIdByName(getContext(), "array", "tencent_tls_ui_countryCode"));

        listPopupWindow = new ListPopupWindow(context);
        listPopupWindow.setAdapter(new ArrayAdapter<String>(context,
                MyResource.getIdByName(getContext(), "layout", "tencent_tls_ui_item"), list));
    ...
    private void setArrow(int flag) {
        ...
        if (UP_ARROW == flag) {
            drawable = getResources().getDrawable(
                    MyResource.getIdByName(getContext(), "drawable", "tencent_tls_ui_up_arrow"));
        } else {
            drawable = getResources().getDrawable(
                    MyResource.getIdByName(getContext(), "drawable", "tencent_tls_ui_down_arrow"));
        }
