package com.yst.onecity.view.pickerview.common.popup;
 ...
 * @version 2015/7/19
 */
public abstract class AbstractBottomPopup<V extends View> implements DialogInterface.OnKeyListener {
    /**
     ...
     */
    public AbstractBottomPopup(Activity activity) {
