...
public class ShoppingMallHolder extends AbstractTypeViewHolder<ShoppingMallBean.ContentBean> {
    ...
    public ShoppingMallHolder(View itemView) {
        super(itemView);
        ButterKnife.bind(this, itemView);
    }

    @Override
    public void bindHolder(ShoppingMallBean.ContentBean item) {
        id = item.getId();
        ...
        List<ShoppingMallBean.ContentBean.MemberImgBean> memberImg = item.getMemberImg();
        tvStory.setText(item.getConsultaionNum() + Const.CONS_STR_STORY);
        MyLog.e("aaa", "memberImg.size()————————" + memberImg.size());
        MyLog.e("aaa", "tvPrice————————" + item.getSalePrice());
