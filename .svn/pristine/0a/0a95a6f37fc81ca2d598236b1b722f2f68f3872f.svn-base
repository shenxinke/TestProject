    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (getItemViewType(position)) {
            ...
            case TYPE_PRODUCT:
                ...
                if (infiList.get(position).getProductType() == Const.INTEGER_1) {
                    productHolder.mallItemType.setImageResource(R.mipmap.this_locality);
                } else if (infiList.get(position).getProductType() == Const.INTEGER_0) {
                    productHolder.mallItemType.setImageResource(R.mipmap.label);
                }
