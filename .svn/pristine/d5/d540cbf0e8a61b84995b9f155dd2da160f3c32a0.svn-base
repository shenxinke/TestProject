...
public class ShareCommonDialog extends DialogFragment {
    ...
    public void toConstantList() {
        ...
        it.putExtra("sms_body", "您好，您的好友" + TianyiApplication.appCommonBean.getNickname() + "正在普济一城买商品，快来围观\n" + invitateDtr);
    ...
    private void share(SHARE_MEDIA platform, Boolean isNetImg) {
        Const.ISSHAREING = true;
        switch (mShareContentType) {
            case Const.SHARE_CONTENTTYPE_VIDEO:
                ...
                break;
            case Const.SHARE_CONTENTTYPE_TEXTIMAGE:
            default:
                new ShareAction(getActivity())
                        .setPlatform(platform)
                        .setCallback(umShareListener)
                        ...
                        .withText(content)
                        .withTargetUrl(url)
                        .withMedia(isNetImg ? getImageUrl() : getImageResource())
                        .share();
                break;
        }
    ...
    private UMVideo getUMVideo() {
        ...
        //视频的缩略图
        video.setThumb(isNetImage ? getImageUrl() : getImageResource());
        //视频的描述
    ...
    private UMImage getImageResource() {
        UMImage image = new UMImage(getActivity(), R.drawable.icon_logo);
        return image;
    }
    ...
    private UMShareListener umShareListener = new UMShareListener() {
        ...
        public void onResult(SHARE_MEDIA platform) {
            ...
            if (WEIXIN_FAVORITE.equals(platform.name())) {
                ...
                if (mPageType == Const.SHARE_PAGETYPE_PX) {
     ...
     * @param type
     */
    public void setSharePageType(int type) {
        this.mPageType = type;
    }
     ...
     * @param type
     */
    public void setShareContentType(int type) {
        this.mShareContentType = type;
    }
