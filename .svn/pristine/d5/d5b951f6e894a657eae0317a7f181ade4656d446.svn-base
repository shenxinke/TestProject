...
public class InputTextWatcher implements TextWatcher {
    ...
    private boolean isLimitColor;
    private int color;
    private TextView numTextView;

    public InputTextWatcher(int limit, EditText text, Context context, TextView tvNum) {
        this.limit = limit;
        this.text = text;
     ...
     * 是否在达到字数限制时颜色改变
     *
     * @param isLimitColor boolean
     */
    public void setColor(boolean isLimitColor, int color, TextView numText) {
        this.isLimitColor = isLimitColor;
        this.color = color;
        this.numTextView = numText;
    }
