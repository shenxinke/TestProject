...
public class ShoppingMallAllFragment extends BaseFragment {
     ...
     * @return 具体fragment
     */
    public static ShoppingMallAllFragment newInstance() {
        ShoppingMallAllFragment fragment = new ShoppingMallAllFragment();
        return fragment;
    }
