...
public class FlowCheckLayout extends ViewGroup {
    ...
    public FlowCheckLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        colorNormal = typedArray.getColor(R.styleable.FlowCheckLayout_color_normal, ContextCompat.getColor(getContext(), R.color.color_80000000));
        colorCheck = typedArray.getColor(R.styleable.FlowCheckLayout_color_check, ContextCompat.getColor(getContext(), R.color.color_80000000));
        bgResNormal = typedArray.getDrawable(R.styleable.FlowCheckLayout_bg_normal) == null ? ContextCompat.getDrawable(getContext(), R.drawable.shape_main_btm_no_click) : typedArray.getDrawable(R.styleable.FlowCheckLayout_bg_normal);
        bgResCheck = typedArray.getDrawable(R.styleable.FlowCheckLayout_bg_check) == null ? ContextCompat.getDrawable(getContext(), R.drawable.shape_main_btm_clickble) : typedArray.getDrawable(R.styleable.FlowCheckLayout_bg_check);
