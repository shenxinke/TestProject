...
public class IndependentLoginActivity extends Activity {
    ...
    private int loginWay = Constants.USRPWD_LOGIN;

    final static int STR_ACCOUNT_REG_REQUEST = 20001;
    final static int SMS_LOGIN_REQUEST = 20002;
//    private int loginWay = Constants.USRPWD_LOGIN | Constants.QQ_LOGIN | Constants.WX_LOGIN;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(MyResource.getIdByName(getApplication(), "layout", "tencent_tls_ui_activity_independent_login"));
        ...
        // 账号密码登录
        if ((loginWay & Constants.USRPWD_LOGIN) != 0) {
            ...
            public void run() {
                ...
                if (userInfo != null) {
                    EditText editText = (EditText) IndependentLoginActivity.this
                            .findViewById(MyResource.getIdByName(getApplication(), "id", "username"));
    ...
    private void initAccountLoginService() {
        ...
        // 手机短信登录
        findViewById(MyResource.getIdByName(getApplication(), "id", "hostLogin"))
                .setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
...
//            }
    ...
    protected void onResume() {
        ...
        if (username != null && password != null) {
            ((EditText) findViewById(MyResource.getIdByName(getApplication(), "id", "username"))).setText(username);
            ((EditText) findViewById(MyResource.getIdByName(getApplication(), "id", "password"))).setText(password);
