...
public class SmsRegisterService {
     ...
     * 处理短信登录过程中遇到的各种情况
     */
    private SmsRegListener smsRegListener;
    /**
     * Activity
     */
                              ...
                              Button btnRegister)
    {
        ...
        this.btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // 获取手机号
                phoneNumber = SmsRegisterService.this.txtPhoneNumber.getText().toString();
                // 获取验证码
                checkCode = SmsRegisterService.this.txtCheckCode.getText().toString();
