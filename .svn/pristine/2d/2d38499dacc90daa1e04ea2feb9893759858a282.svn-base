...
import com.yst.onecity.activity.chat.AddFriendActivity;
import com.yst.onecity.activity.chat.ProfileActivity;
...
public class FriendProfile implements ProfileSummary {
    ...
    public String getGroupName(){
        if (profile.getFriendGroups().size() == 0){
            return TianyiApplication.getContext().getString(R.string.default_group_name);
        }else{
