...
public class VoiceMessage extends AbstractMessage {
    ...
    public void showMessage(ChatAdapter.ViewHolder viewHolder, Context context) {
        LinearLayout linearLayout = new LinearLayout(TianyiApplication.getContext());
        linearLayout.setOrientation(LinearLayout.HORIZONTAL);
        linearLayout.setGravity(Gravity.CENTER);
        ImageView voiceIcon = new ImageView(TianyiApplication.getContext());
    ...
    public String getSummary() {
        return TianyiApplication.getContext().getString(R.string.summary_voice);
    }
