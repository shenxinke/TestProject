...
import com.yst.onecity.view.pickerview.common.popup.AbstractConfirmPopup;
...
public abstract class AbstractWheelPicker extends AbstractConfirmPopup<View> {
     ...
     * The Line color.
     */
    int lineColor = WheelView.LINE_COLOR;
    /**
     * The Line visible.
     */
     ...
     */
    AbstractWheelPicker(Activity activity) {
        super(activity);
    }
