    ...
    private void showDialog() {
        mVerifyDialog = new AbstractSaveDialog(this) {
            ...
            public void onSureClick() {
                ...
                JumpIntent.jump(CashActivity.this, RealNameAuthenticationActivity.class);
                finish();
            }
        ...
        bindCard = new AbstractSaveDialog(this) {
            ...
            public void onSureClick() {
                ...
                JumpIntent.jump(CashActivity.this, UserBindCardPhoneActivity.class, bundle);
                finish();
            }
        ...
        OkHttpUtils.post().url(Constants.SERVER_MEMBER_CASH)
            ...
            public void onResponse(String response, int id) {
                ...
                if (cashBean != null && cashBean.getCode() == 1) {
                    ...
                    JumpIntent.jump(CashActivity.this, CashStateActivity.class, bundle);
                    finish();
                } else {
                    Bundle bundle = new Bundle();
