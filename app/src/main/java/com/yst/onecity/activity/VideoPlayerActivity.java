        ...
        switch (v.getId()) {
            case R.id.iv_share:
                if (mShareCommonDialog == null) {
                    mShareCommonDialog = ShareCommonDialog.openShareDialog(VideoPlayerActivity.this, "普济一城", videoTitle, shareVidelUrl, imgUrl);
                ...
                .execute(new AbstractVideoDetailsCallBack() {
                    ...
                    public void onResponse(VideoDetailInfo response, int id) {
                        if (Const.INTEGER_1 == response.getCode()) {
                            ...
                            shareVidelUrl = Constants.SHARE_CONSULT + "share_video.html" + "?id=" + videoInfo.getId();
