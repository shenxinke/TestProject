...
public class BaseInfoAtivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (null != getIntent() && null != getIntent().getExtras()) {
            ...
            if (!getIntent().getExtras().containsKey(Const.CONS_STR_HEADID) ||
            ...
            if (TextUtils.isEmpty(oneWorld)) {
                binding.edOneWord.setText(getString(R.string.tv_intro));
            } else {
    ...
    public class MyHandler {
        ...
        public void onViewClick(View view) {
            ...
            bundle.putString("simpleIntro", binding.tvIntro.getText().toString());
            JumpIntent.jump(BaseInfoAtivity.this, SimpleIntroActivity.class, bundle, Const.INTEGER_0);
        }
            ...
            public void onResponse(CodeMsgBean response, int id) {
                if (null != response) {
                    ...
                    if (response.getCode() == Const.INTEGER_1) {
                        finish();
                        KeyBoardUtils.closeKeybord(binding.edOneWord, BaseInfoAtivity.this);
                        KeyBoardUtils.closeKeybord(binding.etNickName, BaseInfoAtivity.this);
                    }
                }
            }
        });
