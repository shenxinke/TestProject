...
public class CommissionerHomePageActivity extends BaseActivity implements ViewPager.OnPageChangeListener {
    ...
    @OnClick({R.id.tv_setting_zhuanyuan, R.id.ll_goods, R.id.ll_share, R.id.ll_customer, R.id.ll_comment, R.id.iv_share, R.id.iv_edit, R.id.iv_back, R.id.iv_head, R.id.tv_nick_name, R.id.tv_title, R.id.tv_left, R.id.tv_commissioner_intro})
...
//                    String zhuanYuan = "http://123.207.157.207:10000/tymobile/html/" + "?hunterId=" + TianyiApplication.appCommonBean.getHunter_id() + "&phone=" + TianyiApplication.appCommonBean.getPhone();
            ...
            case R.id.iv_edit:
                //签名
            case R.id.tv_commissioner_intro:
