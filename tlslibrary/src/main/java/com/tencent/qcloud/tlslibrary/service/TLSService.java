...
///        TIMManager.getInstance().setEnv(1);
        ...
        // 不走sso
///        loginHelper.setTestHost("113.108.64.238", false);
        ...
        // 不走sso
//        accountHelper.setTestHost("113.108.64.238", false);
    ...
    public void initAccountLoginService(Context context,
                                        ...
                                        Button btnLogin) {
        accountLoginService = new AccountLoginService(context, txtUsername, txtPassword, btnLogin);
    }
    ...
    public void initPhonePwdLoginService(Context context,
                                         ...
                                         EditText txtPwd,
                                         Button btnLogin) {
        phonePwdLoginService = new PhonePwdLoginService(context, txtCountrycode, txtPhone, txtPwd, btnLogin);
    }
    ...
    public void initPhonePwdRegisterService(Context context,
                                            ...
                                            Button btnRequireCheckCode,
                                            Button btnVerify) {
        phonePwdRegisterService = new PhonePwdRegisterService(context, txtCountrycode, txtPhoneNumber, txtCheckCode, btnRequireCheckCode, btnVerify);
    }
    ...
    public void initResetPhonePwdService(Context context,
                                            ...
                                            Button btnRequireCheckCode,
                                            Button btnVerify) {
        resetPhonePwdService = new ResetPhonePwdService(context, txtCountrycode, txtPhoneNumber, txtCheckCode, btnRequireCheckCode, btnVerify);
    }
    ...
    public void initAccountRegisterService(Context context,
                                           ...
                                           Button btnRegister) {
        accountRegisterService = new AccountRegisterService(context, txtUsername, txtPassword, txtRepassword, btnRegister);
    }
    ...
    * 代理QQ登录的接口
    * */
    public void initQQLoginService(Activity activity, Button btnQqlogin) {
        qqLoginService = new QQLoginService(activity, btnQqlogin);
    }
     ...
     * 代理微信登录的接口
     * */
    public void initWXLoginService(Context context, Button btnWxlogin) {
        wxLoginService = new WXLoginService(context, btnWxlogin);
    }
