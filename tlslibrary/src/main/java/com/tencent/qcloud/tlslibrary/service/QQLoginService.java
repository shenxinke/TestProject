...
public class QQLoginService {
    ...
    public QQLoginService(Activity activity, Button btnHostQQLogin) {
                ...
                switch (msg.arg1) {
                    ...
                    case AUTHORIZATION_SUCC: {
                        ...
                        try {
                            ...
                            accessToken = object.getString("access_token").toString();
...
///                            Util.showToast(QQLoginService.this.activity, sBuilder.toString());
        ...
        btnHostQQLogin.setOnClickListener(new View.OnClickListener() {
            @Override
...
///        activity.finish();
        ...
        intent.putExtra(Constants.EXTRA_QQ_ACCESS_TOKEN, accessToken);
